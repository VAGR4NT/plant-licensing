...
class BaseBusinessForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div("mo_address", css_class="form-row full-width"),
            Div("mo_city", "mo_state", "mo_zip", css_class="form-row three-col"),
            ...
            Div(
                "num_labels", css_class="form-row full-width", style="margin-top: 10px;"
            ),
            HTML("<div class='section-title'>Suppliers</div>"),
            Div("suppliers", css_class="form-row full-width"),
        )
...
class NurseryForm(BaseBusinessForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout.append(
            HTML(
                "<div class='section-title' style='color: #2e7d32;'>Nursery Specifics</div>"
            )
        )

        self.helper.layout.append(Div("acreage", css_class="form-row full-width"))
...
class LocationForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        if self.business_id:
            self.fields["business"].initial = Businesses.objects.get(
                pk=self.business_id
            )
...
class ComplianceForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["business", "agreement_number", "articles_covered"]
        widgets = {}
...
class SupplierForm(forms.ModelForm):
    ...
    class Meta:
        model = Suppliers
        fields = ["supplier_name", "address", "city", "state", "zip_code"]
        widgets = {}


# nursery/dealer fillable pdf update
